...
ingress the only way to reach the UI is `https://192.168.0.101:8006`
...
Add DNS rewrite in AdGuard: `proxmox.kds-dev.com → 192.168.0.120`
...
- Points at node1 (`192.168.0.101`) — if node1 is down access Proxmox
